...
class ModulesRegistrar {
	...
	{
		$category_array = apply_filters('baseline_module_categories', $this->config->getCategoriesConfig());
	...
	{
		$modules_array = apply_filters('baseline_content_modules',  $this->config->getModulesConfig());
